defmodule IndicatorsWeb.UnitLive.Index do
  ...
  def mount(_params, _session, socket) do
    {:ok, stream(socket, :units, Models.list_units())}
  end
  ...
  @impl true
  def handle_info({IndicatorsWeb.UnitLive.FormComponent, {:saved, unit}}, socket) do
    {:noreply, stream_insert(socket, :units, unit)}
  end

  @impl true
  def handle_event("delete", %{"id" => id}, socket) do
    unit = Models.get_unit!(id)
    {:ok, _} = Models.delete_unit(unit)
